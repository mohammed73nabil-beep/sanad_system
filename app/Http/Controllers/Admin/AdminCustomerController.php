    ...
    public function index(Request $request): Response
    {
        ...
        $customers->through(fn ($user) => [
            ...
            'subscription' => $user->latestSubscription ? [
                ...
                'start_date'      => $user->latestSubscription->start_date ? ($user->latestSubscription->start_date instanceof \Carbon\Carbon ? $user->latestSubscription->start_date->format('Y-m-d') : (string) $user->latestSubscription->start_date) : '—',
                'end_date'        => $user->latestSubscription->end_date ? ($user->latestSubscription->end_date instanceof \Carbon\Carbon ? $user->latestSubscription->end_date->format('Y-m-d') : (string) $user->latestSubscription->end_date) : '—',
